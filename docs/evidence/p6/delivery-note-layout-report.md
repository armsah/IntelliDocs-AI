...
- Field coverage: **0.0000**
- Raw exact-match rate: **0.0000**
- Normalized exact-match rate: **0.0000**
- Missing fields: **4**
- Unexpected fields: **0**
...
| --- | ---: | ---: | ---: | ---: |
| customerName | 1 | 0.0000 | 0.0000 | - |
| deliveryDate | 1 | 0.0000 | 0.0000 | - |
| deliveryNoteNumber | 1 | 0.0000 | 0.0000 | - |
| supplierName | 1 | 0.0000 | 0.0000 | - |

## Per-document-type summary

| Type | Documents | Classification accuracy | Field coverage | Normalized extraction |
| --- | ---: | ---: | ---: | ---: |
| delivery_note | 1 | not evaluated | 0.0000 | 0.0000 |
