...
| --- | ---: | ---: | ---: | ---: |
| customerName | 1 | 1.0000 | 1.0000 | 0.9950 |
| deliveryDate | 1 | 1.0000 | 1.0000 | 0.9950 |
| deliveryNoteNumber | 1 | 1.0000 | 1.0000 | 0.9950 |
| supplierName | 1 | 1.0000 | 1.0000 | 0.9950 |

## Per-document-type summary

| Type | Documents | Classification accuracy | Field coverage | Normalized extraction |
| --- | ---: | ---: | ---: | ---: |
| delivery_note | 1 | not evaluated | 1.0000 | 1.0000 |
